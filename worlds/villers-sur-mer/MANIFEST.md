# World Manifest: Villers-sur-Mer

## Overview

**Genre:** Contemporary Fantasy (Love Story with Magical Consequences)
**Setting:** West Brittany, France (Summer)
**Tone:** Melancholic, romantic, introspective, with underlying dread
**Population:** ~50 residents in a small coastal village

## Files

### World Rules
- `lore.md` -- Setting, geography, magic system (the Creature), atmosphere

### Author's Vision
- `intentions.md` -- Themes, character arcs, ending direction, rails, boundaries
